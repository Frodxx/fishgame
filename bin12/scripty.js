...
$(document).ready(function(){
			...
			buildPlayground = function(){
				...
				$('.fishy').draggable();				
				$('#endBtn').click(imDone);
				//$('#endBtn').vclick(imDone);
				$('#resetBtn').click(resetUI);
				//$('#resetBtn').vclick(resetUI);
				$('#halpy').click(function(){
				//$('#halpy').vclick(function(){
